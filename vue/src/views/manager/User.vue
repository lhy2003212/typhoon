<template>
  <div>
    <div class="search">
      ...
      <el-input placeholder="请输入名字查询" style="width: 200px" v-model="name"></el-input>
    ...
    <el-dialog title="用户" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="生日" prop="birth">
          <el-date-picker v-model="form.birth" value-format="yyyy-MM-dd" format="yyyy-MM-dd" style="width:100%"></el-date-picker>
        </el-form-item>

<template>
  <div>
    <div class="search">
      ...
      <el-input placeholder="请输入分类查询" style="width: 200px;margin-left: 10px" v-model="categoryName"></el-input>
    ...
    <el-dialog title="博客内容" :visible.sync="fromVisible1" width="70%" :close-on-click-modal="false" destroy-on-close>
      <div class="w-e-text">
